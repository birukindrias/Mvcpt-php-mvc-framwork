                ...
                <div class="w-full px-4">
                    <div class="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white py-16 px-10 text-center sm:px-12 md:px-[60px]">
                        ...
                        <form action="/login" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-10">
                                <input type="submit" value="Login" name="submit" class="bordder-primary w-full cursor-pointer rounded-md border bg-blue-500 py-3 px-5 text-base text-white transition hover:bg-opacity-90" /> </div>
                        </form>
